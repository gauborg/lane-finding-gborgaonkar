...
def lanelines(image):
    ...
    mpimg.imsave(os.path.join("test_images_output/" + i + "-canny-region-output.png"), selected_region)
...
for i in directory:
    ...
    mpimg.imsave(os.path.join("test_images_output/" + i + "-output.png"), weighted_image)
